            ...
            <form wire:submit.prevent="save">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select form-control @error('category_id') is-invalid @enderror" id="category_id" wire:model="category_id">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control @error('short_description') is-invalid @enderror" id="short_description" wire:model="short_description" rows="3" placeholder="A brief summary of the product"></textarea>
                        @error('short_description') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-md-12 mb-3">
                        <label for="long_description" class="form-label">Long Description</label>
                        <textarea class="form-control @error('long_description') is-invalid @enderror" id="long_description" wire:model="long_description" rows="5" placeholder="Detailed description of the product"></textarea>
                    ...
                    @else
                    {{-- Placeholder for quantity when not needed for parent product --}}
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $thumbnail_image_path) }}" alt="Current Thumbnail" style="max-height: 100px; max-width: 100px; object-fit: cover;">
